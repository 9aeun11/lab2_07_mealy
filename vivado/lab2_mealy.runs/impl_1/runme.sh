...
HD_PWD='C:/Users/gaeun/Desktop/lab2_07_mealy/vivado/lab2_mealy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_mealy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_mealy.tcl -notrace
